...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenTriage }) => {
  return (
    <section id="sobre" className="py-20 sm:py-28 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          
          {/* Left Column: Official Studio Photography */}
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md double-bezel">
              <div className="double-bezel-inner overflow-hidden p-3 bg-slate-900">
          ...
          <div className="lg:col-span-7 flex flex-col items-start">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-50 border border-teal-200 text-teal-800 text-xs font-semibold tracking-wider uppercase mb-4">
