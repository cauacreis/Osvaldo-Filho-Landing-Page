  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (hero) {
        ...
        // Visible when scrollY > 500 or when hero bottom is scrolled past (<= 120px)
        const pastHero = window.scrollY > 500 || rect.bottom <= 120
      ...
      <AnimatePresence>
        {isVisible && (
          <motion.header
            ...
            className="fixed top-0 left-0 right-0 z-40 py-3"
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <nav
                aria-label="Navegação principal"
                className="flex items-center justify-between px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-slate-950/85 backdrop-blur-xl shadow-2xl shadow-black/50 border border-white/10"
              >
                {/* Logo */}
                <a
                  href="#hero"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="lg:hidden p-2 rounded-full text-slate-300 hover:text-white hover:bg-white/10 focus:outline-none cursor-pointer"
